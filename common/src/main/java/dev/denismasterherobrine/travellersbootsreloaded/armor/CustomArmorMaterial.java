package dev.denismasterherobrine.travellersbootsreloaded.armor;
...
public class CustomArmorMaterial implements ArmorMaterial {
    private static int[] HEALTH_PER_SLOT = new int[]{1, 1, 1, 1};
    ...
    public int[] setHealthPerSlot(int[] slots) {
        HEALTH_PER_SLOT = slots;
        return slots;
    }
